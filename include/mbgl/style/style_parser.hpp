...
private:
    ...
    template <typename T>
    bool parseOptionalProperty(const char *property_name, PropertyKey key, ClassProperties &klass, JSVal value, PropertyValue &propertyValue);
    template <typename T>
    ...
    template <typename T>
    bool setProperty(JSVal value, const char *property_name, PropertyKey key, ClassProperties &klass, PropertyValue &propertyValue);
    template <typename T>
    ...
    template <typename T>
    std::tuple<bool, T> parseProperty(JSVal value, const char *property_name, PropertyValue &propertyValue);
