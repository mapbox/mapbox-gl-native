...
TEST(HTTPFileSource, TEST_REQUIRES_SERVER(HTTP200)) {
    ...
    auto req = fs.request({Resource::Unknown, "http://127.0.0.1:3000/test"},
                          [&](Response res) {
...
TEST(HTTPFileSource, TEST_REQUIRES_SERVER(HTTP404)) {
    ...
    auto req = fs.request({Resource::Unknown, "http://127.0.0.1:3000/doesnotexist"},
                          [&](Response res) {
...
TEST(HTTPFileSource, TEST_REQUIRES_SERVER(HTTPTile404)) {
    ...
    auto req = fs.request({Resource::Tile, "http://127.0.0.1:3000/doesnotexist"},
                          [&](Response res) {
...
TEST(HTTPFileSource, TEST_REQUIRES_SERVER(HTTP200EmptyData)) {
    ...
    auto req = fs.request({Resource::Unknown, "http://127.0.0.1:3000/empty-data"},
                          [&](Response res) {
...
TEST(HTTPFileSource, TEST_REQUIRES_SERVER(HTTP204)) {
    ...
    auto req = fs.request({Resource::Unknown, "http://127.0.0.1:3000/no-content"},
                          [&](Response res) {
                              EXPECT_TRUE(res.noContent);
                              EXPECT_FALSE(bool(res.error));
                              EXPECT_FALSE(bool(res.data));
...
TEST(HTTPFileSource, TEST_REQUIRES_SERVER(HTTP500)) {
    ...
    auto req = fs.request({Resource::Unknown, "http://127.0.0.1:3000/permanent-error"},
                          [&](Response res) {
                              ASSERT_NE(nullptr, res.error);
