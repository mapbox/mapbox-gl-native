...
bool multiPolygonIntersectsBufferedMultiPoint(const GeometryCollection& multiPolygon,
...
bool multiPolygonIntersectsBufferedMultiLine(const GeometryCollection& multiPolygon,
...
bool multiPolygonIntersectsMultiPolygon(const GeometryCollection& multiPolygonA,
                                        const GeometryCollection& multiPolygonB) {
    ...
    for (auto& ring : multiPolygonB) {
        for (auto& p : ring) {
            if (multiPolygonContainsPoint(multiPolygonA, p)) {
                return true;
            }
        }
    }
    ...
    for (auto& polygon : multiPolygonA) {
        for (auto& p : polygon) {
            if (multiPolygonContainsPoint(multiPolygonB, p)) {
                return true;
            }
        }

        for (auto& polygonB : multiPolygonB) {
            if (lineIntersectsLine(polygon, polygonB)) {
                return true;
            }
        }
    }
