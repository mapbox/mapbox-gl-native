...
public:
    ...
    PaintProperty<Color> iconColor { Color(0, 0, 0, 1) };
    PaintProperty<Color> iconHaloColor { Color(0, 0, 0, 0) };
    ...
    PaintProperty<Color> textColor { Color(0, 0, 0, 1) };
    PaintProperty<Color> textHaloColor { Color(0, 0, 0, 0) };
