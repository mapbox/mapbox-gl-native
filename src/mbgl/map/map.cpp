...
Map::Map(View& view, FileSource& fileSource, Scheduler& workerThreadPool, MapMode mapMode, GLContextMode contextMode, ConstrainMode constrainMode, ViewportMode viewportMode)
    : impl(std::make_unique<Impl>(view, fileSource, workerThreadPool, mapMode, contextMode, constrainMode, viewportMode)) {
...
Map::Impl::Impl(View& view_,
    ...
    : view(view_),
      fileSource(fileSource_),
      workerThreadPool(workerThreadPool_),
