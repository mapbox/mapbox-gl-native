...
* Enable variable label placement when the `textAllowsOverlap` property on a `MGLSymbolStyleLayer` is set to true. ([#15354](https://github.com/mapbox/mapbox-gl-native/pull/15354))
