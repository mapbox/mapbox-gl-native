...
* A style can now display smooth hillshading and customize its appearance at runtime using the `MGLHillshadeStyleLayer` class. ([#10642](https://github.com/mapbox/mapbox-gl-native/pull/10642))
