...
* Enable client-side rendering for `Kanji` characters using Apple system default font by default. Set `MGLIdeographicFontFamilyName` to `NULL`  in `info.plist` for using custom remote CJK glyphs font([#14862](https://github.com/mapbox/mapbox-gl-native/pull/14862))
