...
* The UITapGestureRecognizer on MGLMapView that is used for selection annotations now fails if a tap does not select an annotation. ([#7246](https://github.com/mapbox/mapbox-gl-native/pull/7246))
