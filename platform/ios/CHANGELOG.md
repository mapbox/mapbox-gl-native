...
* Enable client-side rendering of CJK glyphs and use `Helvetica` by default. Set `MGLIdeographicFontFamilyName` to `NULL`  in `info.plist` for using custom remote CJK glyphs font([#14862](https://github.com/mapbox/mapbox-gl-native/pull/14862))
