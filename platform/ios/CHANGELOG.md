...
* Added `MGLLoggingConfiguration` and `MGLLoggingBlockHandler` that receive error and fault events from the SDK. ([#13235)(https://github.com/mapbox/mapbox-gl-native/pull/13235))
