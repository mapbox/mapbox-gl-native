...
class Q_DECL_EXPORT QQuickMapboxGL : public QQuickFramebufferObject {
    ...
    Q_PROPERTY(
        QDeclarativeGeoServiceProvider* plugin READ plugin WRITE setPlugin NOTIFY pluginChanged)
    Q_PROPERTY(qreal minimumZoomLevel READ minimumZoomLevel WRITE setMinimumZoomLevel NOTIFY
                   minimumZoomLevelChanged)
    Q_PROPERTY(qreal maximumZoomLevel READ maximumZoomLevel WRITE setMaximumZoomLevel NOTIFY
    ...
    Q_PROPERTY(bool copyrightsVisible READ copyrightsVisible WRITE setCopyrightsVisible NOTIFY
...
public:
    ...
    QList<QVariantMap>& layoutPropertyChanges() {
        return m_layoutChanges;
    }
    QList<QVariantMap>& paintPropertyChanges() {
        return m_paintChanges;
    }
