...
- (void)testPredicates {
    ...
    layer.predicate = [NSPredicate predicateWithFormat:@"$mgl_featureIdentifier = 1"];
    XCTAssertEqualObjects(layer.predicate,  [NSPredicate predicateWithFormat:@"$mgl_featureIdentifier = 1"]);
    layer.predicate = nil;
    XCTAssertNil(layer.predicate);
}
