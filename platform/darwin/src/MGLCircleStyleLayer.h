...
/**
 ...
 Values of this type are used in the `MGLCircleStyleLayer.circlePitchScale` property.
 */
...
/**
 ...
 Values of this type are used in the `MGLCircleStyleLayer.circleTranslateAnchor` property.
 */
