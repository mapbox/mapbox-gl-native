...
CustomLayer::CustomLayer(jni::JNIEnv& env,
                         jni::String layerId,
                         jni::jlong initializeFunction,
                         jni::jlong renderFunction,
                         jni::jlong deinitializeFunction,
                         jni::jlong context)
    : Layer(
          env,
...
#define METHOD(MethodPtr, name) jni::MakeNativePeerMethod<decltype(MethodPtr), (MethodPtr)>(name)
    ...
    jni::RegisterNativePeer<CustomLayer>(
        ...
        std::make_unique<CustomLayer, JNIEnv&, jni::String, jni::jlong, jni::jlong, jni::jlong,
                         jni::jlong>,
        "initialize", "finalize", METHOD(&CustomLayer::update, "nativeUpdate"));
}
