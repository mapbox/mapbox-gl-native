...
BackgroundLayer::BackgroundLayer(jni::JNIEnv& env, jni::String layerId)
    : Layer(env,
            std::make_unique<mbgl::style::BackgroundLayer>(jni::Make<std::string>(env, layerId))) {
}
...
jni::Object<jni::ObjectTag> BackgroundLayer::getBackgroundColor(jni::JNIEnv& env) {
    ...
    Result<jni::jobject*> converted = convert<jni::jobject*>(
        env, layer.as<mbgl::style::BackgroundLayer>()->BackgroundLayer::getBackgroundColor());
...
jni::Object<jni::ObjectTag> BackgroundLayer::getBackgroundPattern(jni::JNIEnv& env) {
    using namespace mbgl::android::conversion;
    Result<jni::jobject*> converted = convert<jni::jobject*>(
        env, layer.as<mbgl::style::BackgroundLayer>()->BackgroundLayer::getBackgroundPattern());
    return jni::Object<jni::ObjectTag>(*converted);
}
...
jni::Object<jni::ObjectTag> BackgroundLayer::getBackgroundOpacity(jni::JNIEnv& env) {
    using namespace mbgl::android::conversion;
    Result<jni::jobject*> converted = convert<jni::jobject*>(
        env, layer.as<mbgl::style::BackgroundLayer>()->BackgroundLayer::getBackgroundOpacity());
    return jni::Object<jni::ObjectTag>(*converted);
}
...
void BackgroundLayer::registerNative(jni::JNIEnv& env) {
    // Lookup the class
    BackgroundLayer::javaClass =
        *jni::Class<BackgroundLayer>::Find(env).NewGlobalRef(env).release();
...
#define METHOD(MethodPtr, name) jni::MakeNativePeerMethod<decltype(MethodPtr), (MethodPtr)>(name)
    ...
    jni::RegisterNativePeer<BackgroundLayer>(
        ...
        std::make_unique<BackgroundLayer, JNIEnv&, jni::String>, "initialize", "finalize",
