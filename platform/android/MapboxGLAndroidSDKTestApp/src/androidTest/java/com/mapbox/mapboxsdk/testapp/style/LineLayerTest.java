...
public class LineLayerTest extends BaseStyleTest {
  ...
  public void testLineOpacityAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getLineOpacity().getFunction().getStops()).getDefaultValue());
  }
  ...
  public void testLineGapWidthAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getLineGapWidth().getFunction().getStops()).getDefaultValue());
  }
  ...
  public void testLineOffsetAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getLineOffset().getFunction().getStops()).getDefaultValue());
  }
  ...
  public void testLineBlurAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getLineBlur().getFunction().getStops()).getDefaultValue());
  }
