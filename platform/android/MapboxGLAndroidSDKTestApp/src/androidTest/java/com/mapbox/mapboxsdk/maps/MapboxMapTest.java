...
public class MapboxMapTest extends BaseActivityTest {
  ...
  public void testTransitionDuration() {
    ...
    onView(withId(R.id.mapView)).perform(new MapboxMapAction((uiController, view) -> {
      ...
      assertEquals("TransitionDuration should match",
        transitionDuration, mapboxMap.getTransitionDuration(), 0);
    }));
  }
  ...
  public void testInfoWindowClickListener() {
    ...
    onView(withId(R.id.mapView)).perform(new MapboxMapAction((uiController, view) -> {
      ...
      assertEquals("InfoWidowClickListener should match",
        clickListener, mapboxMap.getOnInfoWindowClickListener());
    }));
  }
  ...
  public void testInfoWindowCloseListener() {
    ...
    onView(withId(R.id.mapView)).perform(new MapboxMapAction((uiController, view) -> {
      ...
      assertEquals("InfoWindowCloseListener should match",
        listener, mapboxMap.getOnInfoWindowCloseListener());
    }));
  }
  ...
  public void testAddPolylines() {
    ...
    onView(withId(R.id.mapView)).perform(new MapboxMapAction((uiController, view) -> {
      ...
      assertTrue("Polyline should be ignored",
        !mapboxMap.getPolylines().contains(polygonOptions3.getPolyline()));
    }));
  }
