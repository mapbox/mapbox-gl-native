...
public class CircleLayerTest extends BaseStyleTest {
  ...
  public void testCircleRadiusAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getCircleRadius().getFunction().getStops()).getDefaultValue());
  }
  ...
  public void testCircleBlurAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getCircleBlur().getFunction().getStops()).getDefaultValue());
  }
  ...
  public void testCircleOpacityAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getCircleOpacity().getFunction().getStops()).getDefaultValue());
  }
  ...
  public void testCircleStrokeWidthAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getCircleStrokeWidth().getFunction().getStops()).getDefaultValue());
  }
  ...
  public void testCircleStrokeOpacityAsCategoricalSourceFunction() {
    ...
    assertEquals(0.3f, ((CategoricalStops) layer.getCircleStrokeOpacity().getFunction().getStops()).getDefaultValue());
  }
