...
class ViewPagerActivity : AppCompatActivity() {
  ...
  internal class MapFragmentAdapter(fragmentManager: androidx.fragment.app.FragmentManager) : androidx.fragment.app.FragmentStatePagerAdapter(fragmentManager) {
