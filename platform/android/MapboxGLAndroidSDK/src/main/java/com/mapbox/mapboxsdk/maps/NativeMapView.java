...
final class NativeMapView {
    ...
    public long addPolyline(Polyline polyline, boolean withWhiteStroke) {
        ...
        return nativeAddPolylines(nativeMapViewPtr, polylines, withWhiteStroke)[0];
    }

    public long[] addPolylines(List<Polyline> polylines, boolean withWhiteStroke) {
        return nativeAddPolylines(nativeMapViewPtr, polylines.toArray(new Polyline[polylines.size()]), withWhiteStroke);
    }
    ...
    private native long[] nativeAddPolylines(long nativeMapViewPtr, Polyline[] polylines, boolean withWhiteStroke);
