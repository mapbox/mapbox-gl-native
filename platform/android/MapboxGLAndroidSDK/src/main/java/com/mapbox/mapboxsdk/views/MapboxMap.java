...
public class MapboxMap {
     ...
     *
     * @see MapboxMap.OnMapChangedListener#onMapChanged(int)
     */
     ...
     * </p>
     * <p>
     * This event is followed by a series of {@link MapboxMap#REGION_IS_CHANGING} and ends
     * with {@link MapboxMap#REGION_DID_CHANGE}.
     * </p>
     *
     * @see com.mapbox.mapboxsdk.views.MapboxMap.OnMapChangedListener
     */
     ...
     * <p>
     * This event is followed by a series of {@link MapboxMap#REGION_IS_CHANGING} and ends
     * with {@link MapboxMap#REGION_DID_CHANGE_ANIMATED}.
     * </p>
     *
     * @see com.mapbox.mapboxsdk.views.MapboxMap.OnMapChangedListener
     */
     ...
     * </p>
     * <p>
     * This event is followed by {@link MapboxMap#DID_FINISH_LOADING_MAP} or
     * {@link MapboxMap#DID_FAIL_LOADING_MAP}.
     * </p>
     *
     * @see com.mapbox.mapboxsdk.views.MapboxMap.OnMapChangedListener
     */
     ...
     * If you wish to wait for the map to finish loading listen for the {@link MapboxMap#DID_FINISH_LOADING_MAP} event.
     * </p>
     * If the style fails to load or an invalid style URL is set, the map view will become blank.
     * An error message will be logged in the Android logcat and {@link MapboxMap#DID_FAIL_LOADING_MAP} event will be sent.
     *
    ...
    public List<String> getStyleClasses() {
        return mMapView.getStyleClasses();
    }
    ...
    public void setStyleClasses(@NonNull List<String> styleClasses, @IntRange(from = 0) long transitionDuration) {
        mMapView.setStyleClasses(styleClasses, transitionDuration);
    }
    ...
    public void addStyleClass(@NonNull String styleClass) {
        mMapView.addStyleClass(styleClass);
    }
    ...
    public void removeStyleClass(@NonNull String styleClass) {
        mMapView.removeStyleClass(styleClass);
    }
    ...
    public boolean hasStyleClass(@NonNull String styleClass) {
        return mMapView.hasStyleClass(styleClass);
    }
    ...
    public InfoWindowAdapter getInfoWindowAdapter() {
        return mMapView.getInfoWindowAdapter();
    }
    ...
    public OnInfoWindowClickListener getOnInfoWindowClickListener() {
        return mMapView.getOnInfoWindowClickListener();
    }
