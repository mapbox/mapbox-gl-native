...
constexpr const DefaultStyle basic            = { "mapbox://styles/mapbox/basic-v9",              "Basic",              9 };
constexpr const DefaultStyle bright           = { "mapbox://styles/mapbox/bright-v9",             "Bright",             9 };
...
const DefaultStyle orderedStyles[] = {
    streets, outdoors, light, dark, basic, bright, satellite, satelliteStreets,
