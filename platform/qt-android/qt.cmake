...
#TODO merge with platform/qt/qt.cmake

option(WITH_QT_DECODERS "Use builtin Qt image decoders" ON)
option(WITH_QT_4        "Use Qt4 instead of Qt5"        OFF)

set(QT_QMAKE_EXECUTABLE /opt/android-qt5/5.8.0/armeabi-v7a/bin/qmake)
...
if(WITH_QT_4)
    message(STATUS "WITH_QT_4")
    include(platform/qt/qt4.cmake)
else()
    message(STATUS "WITH_QT_5")
